            ...
            <div className="space-y-3">
              ...
              <div className="bg-gray-50 p-4 rounded-md">
                ...
                >
                  ...
                  <TooltipProvider>
                    <div className="flex items-center space-x-2 bg-white border rounded p-3 hover:bg-gray-50">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p className="w-[200px] text-xs">Google Pay is available on Chrome, Safari, and other supported browsers.</p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
                  </TooltipProvider>
                  ...
                  <TooltipProvider>
                    <div className={`flex items-center space-x-2 bg-white border rounded p-3 ${isAppleDevice ? 'hover:bg-gray-50' : 'opacity-60'}`}>
                      <RadioGroupItem value={PAYMENT_METHODS.APPLE_PAY} id="apple_pay" disabled={!isAppleDevice} />
                      <label htmlFor="apple_pay" className={`flex items-center gap-2 text-sm font-medium cursor-pointer flex-1 ${!isAppleDevice && 'cursor-not-allowed'}`}>
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p className="w-[200px] text-xs">Apple Pay is only available on Apple devices with Safari browser.</p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
                  </TooltipProvider>
