  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      <ToggleGroup type="single" value={viewMode} onValueChange={(value) => value && onViewModeChange(value as ViewMode)}>
        <ToggleGroupItem value="largeCards" aria-label="Large Cards View" title="Large Cards">
          <Grid2X2 className="h-4 w-4" />
        </ToggleGroupItem>
        <ToggleGroupItem value="smallCards" aria-label="Small Cards View" title="Small Cards">
